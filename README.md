...
Este proyecto es el **Observatorio de Mediciones de Calidad del Aire**, una
aplicacion de consola en Python desarrollada de forma colaborativa por el
equipo. Su objetivo es registrar y consultar informacion ambiental
proveniente de diferentes municipios y estaciones de monitoreo del pais,
permitiendo gestionar el ciclo de vida (CRUD) de las entidades del dominio:
**municipios**, **estaciones de monitoreo** y **mediciones de calidad del
aire** (PM10 / PM2.5).

La aplicacion persiste los datos en archivos JSON (carpeta `data/`), aplica
las reglas de negocio del Indice de Calidad del Aire (ICA) segun la
Resolucion 2254 de 2017 del Ministerio de Ambiente, y esta construida sobre
una arquitectura **MVC** combinada con los patrones **Repository** y
**Factory Method (GoF)** para facilitar la extension a nuevos contaminantes
